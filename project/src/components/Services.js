...
const Services = () => {
  ...
  return (
    <div ref={sectionRef} className='w-full h-screen p-4'>
      <div className='bg-gray-200 rounded-2xl h-full flex flex-col items-center space-y-8'>

        <div ref={headingRef} className='py-6 mt-4 flex flex-col items-center justify-center'>
          <div className='text-4xl md:text-5xl font-semibold'>Empowering Your Path to Healing</div>
          <p className='text-sm mt-2 text-gray-600'>Explore therapeutic support tailored to your emotional well-being.</p>
        </div>
        ...
        <div className='py-4 px-8 w-[85%] h-[500px] flex items-center justify-center space-x-8'>
          ...
          <div
            ...
            className='p-6 w-[35%] h-full rounded-xl flex flex-col items-center justify-center bg-white hover:-translate-y-2 hover:bg-indigo-100 hover:mb-10 transition-all duration-300 ease-in-out'
          >
